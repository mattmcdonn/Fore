...
var playerOneRectangleColor = Color.gray
var playerTwoRectangleColor = Color.gray
var playerThreeRectangleColor = Color.gray
var playerFourRectangleColor = Color.gray
...
struct SPGameScoreCard: View{
    ...
    @State var saveButtonColor = Color.cyan
    ...
    func determineWinner() -> Int{
        ...
        playerOneStrokes = playerOneTotalStrokes()
        playerTwoStrokes = playerTwoTotalStrokes()
        playerThreeStrokes = playerThreeTotalStrokes()
        playerFourStrokes = playerFourTotalStrokes()
        
        if (playerOneStrokes < playerTwoStrokes) && (playerOneStrokes < playerThreeStrokes) && (playerOneStrokes < playerFourStrokes){
            
            winner = 1
            
        } else if (playerTwoStrokes < playerOneStrokes) && (playerTwoStrokes < playerThreeStrokes) && (playerTwoStrokes < playerFourStrokes){
            
            winner = 2
            
        } else if (playerThreeStrokes < playerOneStrokes) && (playerThreeStrokes < playerTwoStrokes) && (playerThreeStrokes < playerFourStrokes){
            
            winner = 3
            
        } else if (playerFourStrokes < playerOneStrokes) && (playerFourStrokes < playerTwoStrokes) && (playerFourStrokes < playerThreeStrokes){
